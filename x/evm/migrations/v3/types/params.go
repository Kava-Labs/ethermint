...
func NewParams(evmDenom string, enableCreate, enableCall bool, config ChainConfig, extraEIPs ...int64) V2Params {
	return V2Params{
		EvmDenom:          evmDenom,
...
func (p V2Params) EIP712AllowedMsgFromMsgType(msgTypeUrl string) *EIP712AllowedMsg {
